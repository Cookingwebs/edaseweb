...
<div class="--b_prueba_frame opacity" data-frame="3" data-show="0">
    ...
    <div class="--group_input">
        ...
        <label for="p3-2">
            El código de contrato y el grupo de cotización
        </label>
    </div>
    <div class="--group_input">
    ...
    <div class="--group_input">
        ...
        <label for="p3-4">
            El código de contrato, el grupo de cotización y el coeficiente de parcialidad
        </label>
    </div>
    </div>
   <div class="--b_cta">
...
<div class="--b_prueba_frame opacity" data-frame="4" data-show="0">
    ...
    <div class="--group_input">
        ...
        <label for="p4-1">
            Podrá hacer un contrato temporal
        </label>
    </div>
    <div class="--group_input">
        <input type="radio" value="b" name="p4" id="p4-2"> 
        <label for="p4-2">
            Podrá hacer un contrato indefinido
        </label>
    </div>
    <div class="--group_input">
        <input type="radio" value="c" name="p4" id="p4-3"> 
        <label for="p4-3">
            Podrá hacer un contrato temporal o indefinido o fijo discontinuo
        </label>
    </div>
    <div class="--group_input">
        <input type="radio" value="d" name="p4" id="p4-4"> 
        <label for="p4-4">
            Podrá hacer un contrato fijo discontinuo
        </label>
    </div>
</div>
<div class="--b_cta">
...
<div class="--b_prueba_frame opacity" data-frame="5" data-show="0">
    ...
    <div class="--group_input">
        ...
        <label for="p5-1">
            Extinción por modificaciones sustanciales de condiciones de trabajo
        </label>
    </div>
    <div class="--group_input">
...
<div class="--b_prueba_frame opacity" data-frame="6" data-show="0">
    ...
    <div class="--group_input">
        ...
        <label for="p6-2">
            Por duración determinada y como máximo 6 meses
        </label>
    </div>
    <div class="--group_input">
    ...
    <div class="--group_input">
        ...
        <label for="p6-4">
            Por duración determinada y como máximo 1 año
        </label>
    </div>
    </div>
   <div class="--b_cta">
...
<div class="--b_prueba_frame opacity" data-frame="7" data-show="0">
    ...
    <div class="--group_input">
        ...
        <label for="p7-1">
            Incorrecto, en el contrato fijo discontinuo no existe posibilidad de prórroga
        </label>
    </div>
    <div class="--group_input">
...
<div class="--b_prueba_frame opacity" data-frame="8" data-show="0">
    ...
    <div class="--group_input">
        ...
        <label for="p8-1">
            Para realizar los trabajos de naturaleza estacional o vinculados a actividades productivas de temporada
        </label>
    </div>
    <div class="--group_input">
        <input type="radio" value="b" name="p8" id="p8-2"> 
        <label for="p8-2">
            Para el desarrollo de aquellos que no tengan dicha naturaleza pero que, siendo de prestación intermitente, tengan periodos de ejecución ciertos, determinados
        </label>
    </div>
    <div class="--group_input">
        <input type="radio" value="c" name="p8" id="p8-3"> 
        <label for="p8-3">
            Para el desarrollo de aquellos que no tengan dicha naturaleza pero que, siendo de prestación intermitente, tengan periodos de ejecución ciertos, indeterminados
        </label>
    </div>
    <div class="--group_input">
...
<div class="--b_prueba_frame opacity" data-frame="9" data-show="0">
    ...
    <div class="--group_input">
        ...
        <label for="p9-1">
            Un contrato indefinido ya que lo necesitaré siempre cada vez que haya recolecta
        </label>
    </div>
    <div class="--group_input">
        <input type="radio" value="b" name="p9" id="p9-2"> 
        <label for="p9-2">
            Un contrato fijo discontinuo ya que es de naturaleza estacional
        </label>
    </div>
    <div class="--group_input">
        <input type="radio" value="c" name="p9" id="p9-3"> 
        <label for="p9-3">
            Un contrato temporal solo para el tiempo de recolección
        </label>
    </div>
    <div class="--group_input">
        <input type="radio" value="d" name="p9" id="p9-4"> 
        <label for="p9-4">
            Ninguna de los contratos anteriores
        </label>
    </div>
    </div>
   <div class="--b_cta">
...
<div class="--b_prueba_frame opacity" data-frame="10" data-show="0">
    ...
    <div class="--group_input">
        ...
        <label for="p10-1">
            La empresa no le hará llamamiento porque está de baja
        </label>
    </div>
    <div class="--group_input">
    ...
    <div class="--group_input">
        ...
        <label for="p10-3">
            La empresa está obligada a realizar el llamamiento
        </label>
    </div>
    <div class="--group_input">
