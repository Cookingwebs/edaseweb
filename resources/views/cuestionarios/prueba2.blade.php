...
@endif
    <div class="--b_prueba_frame-question">
        ...
        <div class="--group_input">            
            ...
            <label for="p1-1">
                De 3 meses, esta regla será ampliable en los convenios colectivos hasta una duración máxima de 6 meses
            </label>
        </div>
        <div class="--group_input">            
            <input type="radio" value="b" name="p1" id="p1-2"> 
            <label for="p1-2">
                De 6 meses, esta regla será ampliable en los convenios colectivos hasta una duración máxima de 12 meses
            </label>
        </div>
        <div class="--group_input">            
            <input type="radio" value="c" name="p1" id="p1-3"> 
            <label for="p1-3">
                De 6 meses, esta regla será ampliable en los convenios colectivos hasta una duración máxima de 9 meses
            </label>
        </div>
        <div class="--group_input">            
            <input type="radio" value="d" name="p1" id="p1-4"> 
            <label for="p1-4">
                De 6 meses sin opción a ampliación
            </label>
        </div>
    </div>
    <div class="--b_cta">
...
<div class="--b_prueba_frame opacity" data-frame="2" data-show="0">
    ...
    <div class="--group_input">            
        ...
        <label for="p2-1">
            90 días de manera no continuada
        </label>
    </div>
    <div class="--group_input">            
        <input type="radio" value="b" name="p2" id="p2-2">
        <label for="p2-2">
            90 días de manera continuada
        </label>
    </div>
    <div class="--group_input">            
        <input type="radio" value="c" name="p2" id="p2-3">
        <label for="p2-3">
            180 días de manera no continuada
        </label>
    </div>
    <div class="--group_input">            
        <input type="radio" value="d" name="p2" id="p2-4">
        <label for="p2-4">
            180 días de manera continuada
        </label>
    </div>
    </div>
   <div class="--b_cta">
...
<div class="--b_prueba_frame opacity" data-frame="3" data-show="0">
    ...
    <h2 class="--b_prueba_frame-pregunta">3. Tenemos un trabajador con puesto de camarero cuyo contrato eventual por situaciones imprevisibles inició el 01/07/2022, su contrato le vence el 31/08/2022, este contrato tendría opción a:</h2>
           <div class="--group_input">            
               ...
               <label for="p3-1">
               1 prórroga de 24 meses
            </label>
        </div>
           <div class="--group_input">            
               <input type="radio" value="b" name="p3" id="p3-2">
               <label for="p3-2">
               1 prórroga de 6 meses si el convenio no amplía la duración máxima, y de 12 meses si el convenio amplia la duración máxima
            </label>
        </div>
           <div class="--group_input">            
               <input type="radio" value="c" name="p3" id="p3-3">
               <label for="p3-3">
               1 prórroga de 4 meses si el convenio no amplía la duración máxima, y de 10 meses si el convenio amplia la duración máxima
            </label>
        </div>
           <div class="--group_input">            
...
<div class="--b_prueba_frame opacity" data-frame="4" data-show="0">
    ...
    <h2 class="--b_prueba_frame-pregunta">4. Adquirirá la condición de fija la persona que ocupe un puesto de trabajo que haya estado ocupado con o sin solución de continuidad…</h2>
           <div class="--group_input">            
               ...
               <label for="p4-1">
               Durante más de 18 meses en un periodo de 24 meses mediante contratos por circunstancias de la producción
            </label>
        </div>
           <div class="--group_input">            
               <input type="radio" value="b" name="p4" id="p4-2">
               <label for="p4-2">
               Durante más de 12 meses en un periodo de 24 meses mediante contratos por circunstancias de la producción
            </label>
        </div>
           <div class="--group_input">            
               <input type="radio" value="c" name="p4" id="p4-3">
               <label for="p4-3">
               Durante más de 24 meses en un periodo de 36 meses mediante contratos por circunstancias de la producción
            </label>
        </div>
           <div class="--group_input">            
               <input type="radio" value="d" name="p4" id="p4-4">
               <label for="p4-4">
               Durante más de 6 meses en un periodo de 12 meses mediante contratos por circunstancias de la producción
            </label>
        </div>
    </div>
   <div class="--b_cta">
...
<div class="--b_prueba_frame opacity" data-frame="5" data-show="0">
    ...
    <h2 class="--b_prueba_frame-pregunta">5. Si tuviéramos que realizar un alta de un contrato eventual por circunstancias previsibles a tiempo completo en Seguridad Social a través de Sistema Red anotaremos:</h2>
           <div class="--group_input">            
               ...
               <label for="p5-1">
               El código 410, el grupo de cotización 
            </label>
        </div>
           <div class="--group_input">            
               <input type="radio" value="b" name="p5" id="p5-2">
               <label for="p5-2">
               El código 502 y el grupo de cotización
            </label>
        </div>
           <div class="--group_input">            
               <input type="radio" value="c" name="p5" id="p5-3">
               <label for="p5-3">
               El código 402 y el grupo de cotización y el coeficiente de parcialidad
            </label>
        </div>
           <div class="--group_input">            
               <input type="radio" value="d" name="p5" id="p5-4">
               <label for="p5-4">
               El código 402 y el grupo de cotización y el colectivo de trabajadores 968
            </label>
        </div>
    </div>
   <div class="--b_cta">
...
<div class="--b_prueba_frame opacity" data-frame="7" data-show="0">
    ...
    <h2 class="--b_prueba_frame-pregunta">7. El contrato obra y servicio tras el 30/03/2022:</h2>
           ...
           <div class="--group_input">            
               ...
               <label for="p7-3">
               Se puede realizar con una duración máxima de 6 meses
            </label>
        </div>
           <div class="--group_input">            
               <input type="radio" value="d" name="p7" id="p7-4">
               <label for="p7-4">
               Se puede realizar con una duración máxima de 3 años
            </label>
        </div>
    </div>
   <div class="--b_cta">
...
<div class="--b_prueba_frame opacity" data-frame="8" data-show="0">
    ...
    <h2 class="--b_prueba_frame-pregunta">8. A 01/07/2022, en el sector de la construcción, si quisiéramos contratar a un obrero para una obra de 3 meses…</h2>
           <div class="--group_input">            
               ...
               <label for="p8-1">
               Le haríamos un contrato obra y servicio por 3 meses
            </label>
        </div>
           <div class="--group_input">            
               <input type="radio" value="b" name="p8" id="p8-2">
               <label for="p8-2">
               Le haríamos un contrato eventual por 3 meses
            </label>
        </div>
           <div class="--group_input">            
               <input type="radio" value="c" name="p8" id="p8-3">
               <label for="p8-3">
               Le haríamos un contrato indefinido
            </label>
        </div>
           <div class="--group_input">            
               <input type="radio" value="d" name="p8" id="p8-4">
               <label for="p8-4">
               Le podríamos hacer un contrato eventual u obra y servicio
            </label>
        </div>
    </div>
   <div class="--b_cta">
...
<div class="--b_prueba_frame opacity" data-frame="9" data-show="0">
    ...
    <h2 class="--b_prueba_frame-pregunta">9. Tenemos un contrato indefinido en el sector de la construcción, y llegado el fin de la obra, ¿Qué opciones tendríamos?:</h2>
           <div class="--group_input">            
               ...
               <label for="p9-1">
               Realizar una propuesta de recolocación
            </label>
        </div>
           <div class="--group_input">            
               <input type="radio" value="b" name="p9" id="p9-2">
               <label for="p9-2">
               Extinguir el contrato en caso de no poder colocar al trabajador en otro puesto
            </label>
        </div>
           <div class="--group_input">            
...
<div class="--b_prueba_frame opacity" data-frame="10" data-show="0">
    ...
    <h2 class="--b_prueba_frame-pregunta">10. Tenemos un contrato indefinido en el sector de la construcción, y llegado el fin de la obra, le proponemos una recolocación.</h2>
           ...
           <div class="--group_input">            
               ...
               <label for="p10-2">
               El trabajador puede rechazarla con 7 días de antelación 
            </label>
        </div>
           <div class="--group_input">            
           ...
           <div class="--group_input">            
               ...
               <label for="p10-4">
               El trabajador puede rechazarla con 5 días de antelación
            </label>
        </div>
    </div>
   <div class="--b_cta">
