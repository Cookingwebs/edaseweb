<div class="--profesorado js-scroll fade-in" data="1">
    <div class="--profesorado_content_1">
        <div class="--profesorado_foto_principal">
            ...
            <div class="--profesorado_mascara_img_principal" data="4">
                
            </div>
            <div class="--profesorado_mascara_img_principal" data="5">
                
            </div>
            <div class="--profesorado_mascara_img_principal" data="6">
        ...
        <div class="--profesorado_copy" data="6" style="display: none">
            ...
            <p class="--profesorado_cargo" data="6">Profesora y responsable contable</p>
        </div>
    ...
    <div class="--profesorado_content_2">
        <div class="--profesorado_foto_secundaria">
            ...
            <div class="--profesorado_mascara_img_secundaria" data="4"></div>
            <div class="--profesorado_mascara_img_secundaria" data="5"></div>
            <div class="--profesorado_mascara_img_secundaria" data="6"></div>
        </div>
        <div class="--profesorado_texto js-scroll slide-right" data="1">
        ...
        <div class="--profesorado_texto js-scroll slide-right" data="2" style="display: none">
        ...
        <div class="--profesorado_texto js-scroll slide-right" data="3" style="display: none">
        ...
        <div class="--profesorado_texto js-scroll slide-right" data="4" style="display: none">
        ...
        <div class="--profesorado_texto js-scroll slide-right" data="5" style="display: none">
        ...
        <div class="--profesorado_texto js-scroll slide-right" data="6" style="display: none">
            <p>Graduada en Administración y Dirección de Empresas y Finanzas y Contabilidad, y especialista en Contabilidad y Auditoría. <b>Lleva ejerciendo como asesora fiscal, laboral y contable más de 7 años y ha coordinado los departamentos fiscales y laborales de Ayuda T Pymes. Actualmente es profesora de la escuela en el área contable y fiscal.</b></p>
        </div>

        <div class="--profesorado_bloque js-scroll slide-right" data="1"></div>
    </div>
    <div class="--profesorado_franja js-scroll slide-bottom" data="1"></div>
</div>