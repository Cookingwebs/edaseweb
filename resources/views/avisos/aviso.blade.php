...
<div id="avisos-page">
    ...
    <div class="--aside" id="b_pilares">
        <div class="--copy">
            <p class="--section_title">Aviso legal</p>
        </div>
        <div class="--section">
        </div>
        <div class="--content">
            ...
            <p>Denominación Social: AYUDA T LEARNING<br>
