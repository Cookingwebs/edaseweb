...
<div id="avisos-page">
    ...
    <div class="--aside" id="b_pilares">
        <div class="--copy">
            <p class="--section_title">Política de Cookies</p>
        </div>
        <div class="--section">
        </div>
        <div class="--content">
            ...
            <p><strong>Cookies de análisis:&nbsp;</strong>Son aquéllas que bien tratadas por nosotros o por terceros, nos permiten cuantificar el número de usuarios y así realizar la medición y análisis estadístico de la utilización que hacen los usuarios del servicio ofertado. Para ello se analiza su navegación en nuestra página web con el fin de mejorar la oferta de productos o servicios que le ofrecemos.<br><strong>Cookies técnicas:</strong>&nbsp;Son aquellas que permiten al usuario la navegación a través del área restringida y la utilización de sus diferentes funciones, como por ejemplo, llevar a cambio el proceso de compra de un artículo.<br><strong>Cookies de personalización:</strong>&nbsp;Son aquellas que permiten al usuario acceder al servicio con algunas características de carácter general predefinidas en función de una serie de criterios en el terminal del usuario como por ejemplo serian el idioma o el tipo de navegador a través del cual se conecta al servicio.<br><strong>Cookies publicitarias:</strong>&nbsp;Son aquéllas que, bien tratadas por esta web o por terceros, permiten gestionar de la forma más eficaz posible la oferta de los espacios publicitarios que hay en la página web, adecuando el contenido del anuncio al contenido del servicio solicitado o al uso que realice de nuestra página web. Para ello podemos analizar sus hábitos de navegación en Internet y podemos mostrarle publicidad relacionada con su perfil de navegación.<br><strong>Cookies de publicidad comportamental:</strong>&nbsp;Son aquellas que permiten la gestión, de la forma más eficaz posible, de los espacios publicitarios que, en su caso, el editor haya incluido en una página web, aplicación o plataforma desde la que presta el servicio solicitado. Este tipo de cookies almacenan información del comportamiento de los visitantes obtenida a través de la observación continuada de sus hábitos de navegación, lo que permite desarrollar un perfil específico para mostrar avisos<br>publicitarios en función del</p>
            ...
            <p><a target="_blank" href="https://support.google.com/chrome/answer/95647?hl=es" rel="noreferrer noopener">Configurar cookies en Google Chrome</a><br><a target="_blank" href="https://support.microsoft.com/es-es/hub/4338813/windows-help?os=windows-10" rel="noreferrer noopener">Configurar cookies en Microsoft Internet Explorer</a><br><a target="_blank" href="https://support.mozilla.org/es/kb/habilitar-y-deshabilitar-cookies-sitios-web-rastrear-preferencias?redirectlocale=es&amp;redirectslug=habilitar-y-deshabilitar-cookies-que-los-sitios-we" rel="noreferrer noopener">Configurar cookies en Mozilla Firefox</a><br><a target="_blank" href="https://support.apple.com/es-es/HT201265" rel="noreferrer noopener">Configurar cookies en Safari (Apple)</a></p>
            ...
            <h3>FINALIDAD DE LAS COOKIES.</h3>
            <p>Existe una clasificación con cinco tipos de cookies según la finalidad para la que se traten los datos obtenidos:</p>
