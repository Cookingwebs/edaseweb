...
<div id="avisos-page">
    ...
    <div class="--aside" id="b_pilares">
        ...
        <div class="--content">
            ...
            <b>Teléfono:</b> <a href="tel:685482310">685482310</a> <br>
            <b>Email para comunicaciones en materia de Protección de datos:</b> <a href="mailto:info@edase.es">info@edase.es</a></p>
            ...
            <p>Para ejercer sus derechos, debe dirigirse al responsable, solicitando el correspondiente formulario para el ejercicio del derecho elegido. Opcionalmente, puede acudir a la Autoridad de Control competente para obtener información adicional acerca de sus derechos. Los datos de contacto para el ejercicio de sus derechos son el teléfono 685482310 y el correo electrónico: info@edase.es. Recuerde acompañar una copia de un documento que nos permita identificarle.</p>
