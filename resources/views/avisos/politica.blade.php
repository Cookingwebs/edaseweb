...
<div id="avisos-page">
    ...
    <div class="--aside" id="b_pilares">
        <div class="--copy">
            <p class="--section_title">POLÍTICA DE PRIVACIDAD</p>
        </div>
        <div class="--section">
        </div>
        <div class="--content">
            <h3>1. DATOS DEL RESPONSABLE DEL TRATAMIENTO </h3>
            <p><b>Razón Social:</b> AYUDA T LEARNING (en adelante, la “Empresa” o el “Responsable”). <br>
            <b>CIF:</b> B72329949<br>
            <b>Domicilio:</b> C ISAAC NEWTON ESQ.EDMON HALLEY, SN EDIFICIO 287 - 11500 - EL PUERTO DE STA MARIA - CADIZ<br>
            <b>Teléfono:</b> <a href="tel:685089682">685089682</a> <br>
            <b>Email para comunicaciones en materia de Protección de datos:</b> <a href="mailto:carmenmoreno@ayudatlearning.com">carmenmoreno@ayudatlearning.com</a></p>
            ...
            <p>Para ejercer sus derechos, debe dirigirse al responsable, solicitando el correspondiente formulario para el ejercicio del derecho elegido. Opcionalmente, puede acudir a la Autoridad de Control competente para obtener información adicional acerca de sus derechos. Los datos de contacto para el ejercicio de sus derechos son el teléfono 685089682 y el correo electrónico: carmenmoreno@ayudatlearning.com. Recuerde acompañar una copia de un documento que nos permita identificarle.</p>
