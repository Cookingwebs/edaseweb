...
//   }
  ...
  const formCabecera = function(){
      ...
      $('#mba_form .--cta_submit').on('click', function(e){
          e.preventDefault();
          let validMail = false;
          let validPhone = false;
          let validAgree = false;
          ...
          let name = $('#mba_form input[name="name_input"]');
          let phone = $('#mba_form input[name="phone_input"]');
          let email = $('#mba_form input[name="email_input"]');
          let agree = $('#mba_form input[name="aviso_input"]');
          let notificaciones = $('#mba_form input[name="notificaciones_input"]');
          let enterprise = $('#mba_form input[name="enterprise_input"]');
          let canal = "Web";
          ...
          if(validMail && validPhone && validAgree){
              ...
              $.ajax({
                  ...
                  data: datos,
                  beforeSend: function() {
                      $('#mba_form .--cta_submit').attr('disabled');
                      $('#mba_form .--cta_submit').addClass('--spinner');
                    },
                  success: function(result){
                      $('#mba_form .--cta_submit').removeAttr("disabled");
                      $('#mba_form').trigger("reset");
                      $('#mba_form .--cta_submit').removeClass('--spinner');
                      // result = JSON.parse(JSON.stringify(result));
                      console.log(result);
                      if(result == 1){
                          $('.--alert_cabecera_sucess').fadeIn();
      ...
      $('#mba_form_footer .--cta_submit').on('click', function(e){
          e.preventDefault();
          let validMail = false;
          let validPhone = false;
          let validAgree = false;
          ...
          let name = $('#mba_form_footer input[name="name_input"]');
          let phone = $('#mba_form_footer input[name="phone_input"]');
          let email = $('#mba_form_footer input[name="email_input"]');
          let agree = $('#mba_form_footer input[name="aviso_input"]');
          let notificaciones = $('#mba_form_footer input[name="notificaciones_input"]');
          let enterprise = $('#mba_form_footer input[name="enterprise_input"]');
          let canal = "Web";
          let action = $('#mba_form_footer input[name="action"]');
          ...
          if(validMail && validPhone && validAgree){
              ...
              $.ajax({
                  ...
                  data: datos,
                  beforeSend: function() {
                      $('#mba_form_footer .--cta_submit').attr('disabled');
                      $('#mba_form_footer .--cta_submit').addClass('--spinner');
                    },
                  success: function(result){
                      $('#mba_form_footer .--cta_submit').removeAttr("disabled");
                      $('#mba_form_footer').trigger("reset");
                      $('#mba_form_footer .--cta_submit').removeClass('--spinner');
                      // result = JSON.parse(JSON.stringify(result));
                      console.log(result);
                      if(result == 1){
                          $('.--alert_footer_sucess').fadeIn();
      ...
      $('#recomienda_form .--cta_submit').on('click', function(e){
        e.preventDefault();
        let validMail = false;
        let validPhone = false;
        let validAgree = false;
        ...
        let name = $('#recomienda_form input[name="name_input"]');
        let currentName = $('#recomienda_form input[name="current_name_input"]');
        let phone = $('#recomienda_form input[name="phone_input"]');
        let email = $('#recomienda_form input[name="email_input"]');
        let agree = $('#recomienda_form input[name="aviso_input"]');
        let notificaciones = $('#recomienda_form input[name="notificaciones_input"]');
        let enterprise = $('#recomienda_form input[name="enterprise_input"]');
        let canal = "Recomendado Master";
        ...
        if(validMail && validPhone && validAgree){
            ...
            var consulta = `{
                Nombre del que recomienda : ${currentName.val()},
                Email del que recomienda : ${email.val()}
              }`;
      ...
      $('#recomienda_form_footer .--cta_submit').on('click', function(e){
        e.preventDefault();
        let validMail = false;
        let validPhone = false;
        let validAgree = false;
        ...
        let name = $('#recomienda_form_footer input[name="name_input"]');
        let currentName = $('#recomienda_form_footer input[name="current_name_input"]');
        let phone = $('#recomienda_form_footer input[name="phone_input"]');
        let email = $('#recomienda_form_footer input[name="email_input"]');
        let agree = $('#recomienda_form_footer input[name="aviso_input"]');
        let notificaciones = $('#recomienda_form_footer input[name="notificaciones_input"]');
        let enterprise = $('#recomienda_form_footer input[name="enterprise_input"]');
        let canal = "Recomendado Master";
